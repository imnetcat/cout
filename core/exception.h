...
namespace Exceptions
{
	namespace Core
	{
		...
		public:
			...
			const char* what() const noexcept override
			{
				return "The operation did not complete because an application callback set by \
						SSL_CTX_set_client_cert_cb() has asked to be called again. The TLS/SSL \
						I/O function should be called again later";
			}
		};
		...
		public:
			...
			const char* what() const noexcept override
			{
				return "The operation did not complete; the same TLS/SSL I/O function should be \
