# **Email client**
## Concept
  Это реализация фреймворка, а так же простого консольного клиента на его основе, для отправки емейлов на почтовые сервисы (список поддерживаемых ниже) по протоколу SMTP.
